...
bot.on("ready", async () => {
  ...
  bot.user.setActivity("✔ Currently in (Beta)", {type: "WATCHING"});
...
bot.on("message", async message => {
  ...
  if(cmd === `${prefix}report`){
    ...
    let reportschannel = message.guild.channels.find(`name`, "❌punishments");
...
bot.login('NDk2NjY5MTY0NzU3NTgxODI0.DpZ1UQ.HH6JgLT30eCuD57m_b7WFiNGRhM');
